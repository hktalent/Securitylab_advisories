<header class="post-header d-block mb-6">
      <div class="date text-mono f5 my-3">May 27, 2021</div>
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-345: Regular expression Denial of Service in mootools - CVE-2021-32821</h1>
...
<ul>
  <li>12/22/2020: report sent to maintainer</li>
  <li>02/24/2021: request for security contact after no reply to original report</li>
  <li>02/24/2021: current maintainer acknowledges report</li>
  <li>05/25/2021: current maintainer sends update informing they’re treating this issue as a wontfix due to low impact and lack of activity on the project</li>
</ul>
...
<p>mootools is a general purpose DOM manipulation libray.</p>

<p>It includes a CSS selector parser, that is vulnerable to ReDoS.</p>

<p>The attack requires that an attacker can inject a string into a CSS selector at runtime, which is quite commmon with e.g. jQuery CSS selectors.</p>

<p>This issue was detected with the <a href="https://lgtm.com/query/1377211413136097395/">following CodeQL query</a>.</p>

<p>While mootools is a browser library, we have directly invoked the relevant library function to make the PoC simpler.</p>

<ul>
  <li><code class="language-plaintext highlighter-rouge">git clone git@github.com:mootools/mootools-core.git</code></li>
  <li>Run the below with <code class="language-plaintext highlighter-rouge">node</code>.
    <pre><code class="language-JavaScript">var Slick = require("./mootools-core/Source/Slick/Slick.Parser.js");
Slick.Slick.parse(":a(''''''''''''''''''''''''''''''''''''''''''''''''''''''");
</code></pre>
  </li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-345</code> in any communication regarding this issue.</p>
