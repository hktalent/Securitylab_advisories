<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-298: Regular Expression Denial of Service in Metro-UI-CSS</h1>
...
<ul>
  <li>11/29/2020: report sent to project maintainer</li>
  <li>11/30/2020: <a href="https://github.com/olton/Metro-UI-CSS/commit/5b49a4c21ddd30e5aee5ca7585d68b72172177c6">fix get published</a></li>
</ul>
...
<p>Metro-UI-CSS uses a regexp copy-pasted from <a href="https://gist.github.com/dperini/729294">a gist</a> to validate URLs.
Trying to validate a malicious string can cause the regex to loop “forever”.</p>

<p>This vulnerability was found using a <a href="https://securitylab.github.com/tools/codeql/">CodeQL</a> query which identified this regex as vulnerable.
<a href="https://lgtm.com/query/5753484994325761354/">Link to query run</a></p>

<p>The fix is to update to the latest version of that gist the library is based on.</p>

<h3 id="poc">Poc</h3>

<ul>
  <li>Go to this demo page I made: https://codepen.io/webbiesdk/pen/xxOBLGj</li>
  <li>Enter some (fake) email, and then copy-paste the below string as the “Website”.</li>
  <li>Press “Submit” and watch the page become unresponsive (and CPU usage spike to 100%)</li>
</ul>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>http://foobar.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.
</code></pre></div></div>
...
<ul>
  <li><a href="https://github.com/olton/Metro-UI-CSS/issues/1687">Issue</a></li>
  <li><a href="https://github.com/olton/Metro-UI-CSS/commit/5b49a4c21ddd30e5aee5ca7585d68b72172177c6">Fix commit</a></li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-298</code> in any communication regarding this issu