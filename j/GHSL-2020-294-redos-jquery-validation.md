<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-294: ReDoS (Regular Expression Denial of Service) in jquery.validation - CVE-2021-21252</h1>
...
<ul>
  ...
  <li>01/09/2020: <a href="https://github.com/jquery-validation/jquery-validation/security/advisories/GHSA-jxwx-85vp-gvwm">Advisory</a> is published</li>
</ul>
...
<p><code class="language-plaintext highlighter-rouge">jquery.validation</code> does client-side form validation and to validate URLs, it uses a regex copy-pasted from <a href="https://gist.github.com/dperini/729294">a gist</a>.
Trying to validate a malicious string can cause the regex to loop “forever”.</p>

<p>This vulnerability was found using a <a href="https://securitylab.github.com/tools/codeql/">CodeQL</a> query which identified the <code class="language-plaintext highlighter-rouge">chunker</code> regex as vulnerable.
<a href="https://lgtm.com/query/1516761178915016680/">Link to query run</a>.</p>

<h3 id="poc">PoC</h3>

<ul>
  <li>Go to <a href="https://jqueryvalidation.org/files/demo/">this demo site</a>.</li>
  <li>Paste the following text into the URL field:</li>
</ul>
...
<h2 id="cve">CVE</h2>
<ul>
  <li>CVE-2021-21252</li>
</ul>

<h2 id="resources">Resources</h2>
<p><a href="https://github.com/jquery-validation/jquery-validation/security/advisories/GHSA-jxwx-85vp-gvwm">GitHub Security Advisory</a></p>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-294</code> in any communication regarding this issue.</p>
