<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-150: Cross-Site Scripting (XSS) and Cross-Site Request Forgery (CSRF) in china-live/QQConnect</h1>
...
<ul>
  ...
  <li>10/29/2020: Created a public issue asking for a contact</li>
  <li>11/02/2020: Owner acknowledges</li>
  <li>01/26/2021: Public issue created https://github.com/china-live/QQConnect/issues/18</li>
</ul>

<h2 id="summary">Summary</h2>

<p><a href="https://github.com/china-live/QQConnect">QQConnect</a> is vulnerable to Cross-Site Scripting (XSS) and Cross-Site Request Forgery (CSRF) that may lead to the elevation of privileges and per-user denial of service (DoS).</p>

<h2 id="product">Product</h2>

<p><a href="https://github.com/china-live/QQConnect">QQConnect</a></p>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-150</code> in any communication regarding this issue.</p