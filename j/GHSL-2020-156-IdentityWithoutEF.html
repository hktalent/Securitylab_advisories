<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-156: Cross-Site Scripting (XSS) and Cross-Site Request Forgery (CSRF) in IdentityWithoutEF</h1>
...
<p><a href="https://github.com/MatthewKing/IdentityWithoutEF">IdentityWithoutEF</a> is vulnerable to Cross-Site Scripting (XSS) and Cross-Site Request Forgery (CSRF) that may lead to the elevation of privileges and per-user denial of service (DoS).</p>

<h2 id="product">Product</h2>

<p><a href="https://github.com/MatthewKing/IdentityWithoutEF">IdentityWithoutEF</a></p>
...
<ul>
  ...
  <li>11/04/2020: Created a public issue https://github.com/MatthewKing/IdentityWithoutEF/issues/6</li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-156</code> in any communication regarding this issue.</p