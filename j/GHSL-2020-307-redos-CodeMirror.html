<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-307: Regular Expression Denial of Service in CodeMirror</h1>
...
<ul>
  ...
  <li>12/01/2020: <a href="https://github.com/codemirror/CodeMirror/commit/5e11705588c69925dcd8531bc605854bb379150b">fix gets published</a></li>
</ul>
...
<p>This vulnerability was found using a <a href="https://securitylab.github.com/tools/codeql/">CodeQL</a> query which identified the <code class="language-plaintext highlighter-rouge">qualifiedSymbol</code> regular expression as vulnerable.
<a href="https://lgtm.com/query/414605871721065035/">Link to query run</a></p>

<h3 id="poc">PoC</h3>

<p>The below PoC demonstrates how creatively constructed program written in the <code class="language-plaintext highlighter-rouge">clojure</code> programming language can take an extremely long time to parse:</p>

<ul>
  <li>Open this demo page: https://codemirror.net/mode/clojure/index.html</li>
  <li>Paste the below text into an empty line in the editor:</li>
</ul>
...
<ul>
  <li><a href="https://github.com/codemirror/CodeMirror/security/advisories/GHSA-rh98-wv33-m9pm">GitHub Security Advisory (closed)</a></li>
  <li><a href="https://github.com/codemirror/CodeMirror/commit/5e11705588c69925dcd8531bc605854bb379150b">Fix commit</a></li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-307</code> in any communication regarding this issue.</p>
