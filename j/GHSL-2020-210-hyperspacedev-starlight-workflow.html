<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-210: Template injection in the GitHub workflow of hyperspacedev/starlight repository</h1>
...
<p>Automatic GitHub workflow in <a href="https://github.com/hyperspacedev/starlight">hyperspacedev/starlight</a> repository is vulnerable to template injection from user comments.</p>

<h2 id="product">Product</h2>

<p><a href="https://github.com/hyperspacedev/starlight">hyperspacedev/starlight</a> repository</p>
...
<p><a href="https://github.com/hyperspacedev/starlight/blob/root/.github/workflows/jira-create.yml"><code class="language-plaintext highlighter-rouge">Jira Create issue</code> step in jira-create.yml</a> workflow is vulnerable to template injection.</p>
...
<div class="language-yaml highlighter-rouge"><div class="highlight"><pre class="highlight"><code>    <span class="pi">-</span> <span class="na">name</span><span class="pi">:</span> <span class="s">Jira Create issue</span>
      ...
      <span class="na">with</span><span class="pi">:</span>
        <span class="na">project</span><span class="pi">:</span> <span class="s">HS</span>
        <span class="na">issuetype</span><span class="pi">:</span> <span class="s">Task</span>
        <span class="na">summary</span><span class="pi">:</span> <span class="s">${{ github.event.issue.title }}</span>
        <span class="na">description</span><span class="pi">:</span> <span class="s">${{ github.event.issue.body }}</span>
</code></pre></div></div>
...
<ul>
  <li>10/29/2020: Report sent to owner</li>
  <li>10/30/2020: Fixed by vendor</li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-210</code> in any communication regarding this issue.</p>
