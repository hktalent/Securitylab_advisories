<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-299: ReDoS (Regular Expression Denial of Service) in simple-markdown</h1>
...
<ul>
  <li>01/07/2020: report sent to aria+security@toole1.com</li>
  <li>01/08/2020: issue is fixed in <a href="https://github.com/Khan/simple-markdown/pull/95">version 0.7.3</a></li>
</ul>
...
<p>This library parses markdown content and outputs an AST. It is made both for server-side and client-side use.</p>
...
<a href="https://lgtm.com/query/5696115039308894536/">Link to query run</a></p>

<h3 id="poc">PoC</h3>

<ul>
  <li>Install simple-markdown: <code class="language-plaintext highlighter-rouge">npm install simple-markdown</code></li>
  <li>Put the below in a <code class="language-plaintext highlighter-rouge">.js</code> file and run with node.</li>
</ul>

<pre><code class="language-JavaScript">var SimpleMarkdown = require("simple-markdown");
...
<ul>
  <li><a href="https://github.com/Khan/simple-markdown/pull/95">fix PR</a></li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-299</code> in any communication regarding this issue.</p>
