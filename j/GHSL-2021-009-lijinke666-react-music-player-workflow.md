<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2021-009: Unauthorized repository modification or secrets exfiltration in a GitHub workflow of lijinke666/react-music-player</h1>
...
<p>The <a href="https://github.com/lijinke666/react-music-player/blob/master/.github/workflows/surge-preview.yml">surge-preview.yml</a> GitHub workflow is vulnerable to unauthorized modification of the base repository or secrets exfiltration from a Pull Request.</p>

<h2 id="product">Product</h2>

<p><a href="https://github.com/lijinke666/react-music-player">lijinke666/react-music-player GitHub repository</a></p>

<h2 id="tested-version">Tested Version</h2>

<p>The latest changeset <a href="https://github.com/lijinke666/react-music-player/blob/7349832167a0d5cf352dbc7070351a3b6925fc20/.github/workflows/surge-preview.yml">surge-preview.yml</a> to the date.</p>
      ...
      <span class="pi">-</span> <span class="na">uses</span><span class="pi">:</span> <span class="s">afc163/surge-preview@v1</span>
        <span class="na">with</span><span class="pi">:</span>
          ...
          <span class="na">build</span><span class="pi">:</span> <span class="pi">|</span>
            ...
            <span class="s">yarn build:demo</span>
          <span class="na">dist</span><span class="pi">:</span> <span class="s">example/dist</span>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2021-009</code> in any communication regarding this issue.</p>
