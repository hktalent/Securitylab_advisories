<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2021-060: Command injection in @prisma/sdk - CVE-2021-21414</h1>
...
<ul>
  ...
  <li>2021-03-25: Issue is acknowledged.</li>
  <li>2021-03-31: Issue is <a href="https://github.com/prisma/prisma/pull/6245">fixed</a> and <a href="https://github.com/prisma/prisma/security/advisories/GHSA-pxcc-hj8w-fmm7">advisory is published</a>.</li>
</ul>

<h2 id="summary">Summary</h2>

<p>The <code class="language-plaintext highlighter-rouge">getPackedPackage</code> method has a command injection vulnerability. Clients of the @prisma/sdk library are unlikely to be aware of this, so they might unwittingly write code that contains a vulnerability.</p>
...
<h3 id="command-injection-in-getpackedpackage">Command injection in <code class="language-plaintext highlighter-rouge">getPackedPackage</code></h3>

<p>The following proof-of-concept illustrates the vulnerability. First install @prisma/sdk:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>npm install @prisma/sdk
</code></pre></div></div>

<p>Now create a file with the following contents:</p>

<div class="language-plaintext highlighter-rouge"><div class="highlight"><pre class="highlight"><code>const sdk = require("@prisma/sdk");
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2021-060</code> in any communication regarding this issue.</p>
